...
Four types of skills exist in Agent Harbor. See [CONTRIBUTING.md](CONTRIBUTING.md) for the full taxonomy and guidelines.
...
| `/update-nanoclaw` | Bring upstream NanoClaw updates into a customized Agent Harbor install |
...
launchctl kickstart -k gui/$(id -u)/com.agentharbor  # restart
